//
// Created by x on 22/11/2024.
//

#ifndef VIRGIL_LOOP_TRACK_H
#define VIRGIL_LOOP_TRACK_H

#endif //VIRGIL_LOOP_TRACK_H
...
int loop_track() {
    ...
    result = ma_decoder_init_file("resources/test.wav", NULL, &decoder);
